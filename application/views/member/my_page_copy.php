...
$GLOBALS['pageResources'] = [
    'css' => ['/assets/css/member/myPage_copy.css'],
    'js' => ['/assets/js/member/myPage_copy.js']
];
?>

<p>asdf
<figure class="table">
    <table style="border: 1px double #b3b3b3; border-collapse: collapse; border-spacing: 0; height: 47px; overflow: hidden;">
        <thead>
            <tr>
                <th style="background: rgba(0, 0, 0, .05); font-weight: 700; text-align: left; border: 1px solid #bfbfbf; width:fit-content; padding: 0.4em; overflow-wrap: break-word;"><span style="font-size:13px;">&#48708;&#46300;&#53076;&#52845;&#50672;&#44396;&#49548;_&#51228;&#54408;&#50756;&#49457;&#52852;&#54168;_&#45824;&#47928;-20240319-65f94201e39ac.jpg</span></th>
                <th style="background: rgba(0, 0, 0, .05); font-weight: 700; text-align: left; border: 1px solid #bfbfbf; width:fit-content; padding: 0.4em; overflow-wrap: break-word;"><span style="font-size:13px;">24.36KB</span></th>
                <th style="background: rgba(0, 0, 0, .05); font-weight: 700; text-align: left; border: 1px solid #bfbfbf; width:fit-content; padding: 0.4em; overflow-wrap: break-word;"><a href="http://211.238.132.177/assets/file/articleFiles/img/%EB%B9%84%EB%93%9C%EC%BD%94%EC%B9%AD%EC%97%B0%EA%B5%AC%EC%86%8C_%EC%A0%9C%ED%92%88%EC%99%84%EC%84%B1%EC%B9%B4%ED%8E%98_%EB%8C%80%EB%AC%B8-20240319-65f94201e39ac.jpg" download="&#48708;&#46300;&#53076;&#52845;&#50672;&#44396;&#49548;_&#51228;&#54408;&#50756;&#49457;&#52852;&#54168;_&#45824;&#47928;-20240319-65f94201e39ac.jpg" target="_blank"><span style="font-size:28px;">&#128190;</span></a></th>
            </tr>
        </thead>
    </table>
</figure>
        ...
        <? if (isset($_SESSION['user_data'])) : ?>
            ...
            <div class="prfl-box">
                <span class="profile-img">
                    ...
                    <form id="prfl-img-form" action="">
                        <label class="prfl-img-edit" for="member-prfl-img-edit">
                            <input type="file" name="member-prfl-img" id="member-prfl-img-edit" accept="image/jpg, image/jpeg, image/png, image/bmp" hidden>
                        </label>
                    </form>
                </span>
                <span class="nick-and-info">
                    ...
                    <a href="javascript:void(0);" id="member-prfl-file-remove">기존이미지</a>
                    <span class="profile-img-update-btn">
                        <button type="button" id="updatePrflImgBtn">프로필 사진 저장</button>
                    </span>
